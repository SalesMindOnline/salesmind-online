...
// ── STYLES ────────────────────────────────────────────────────────
const styles = {
  app: { minHeight: "100vh", display: "flex", flexDirection: "column", background: "#fff" },
  header: { borderBottom: "1px solid var(--border)", padding: "16px 24px", background: "#fff" },
  headerInner: { maxWidth: 960, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" },
  logo: { fontFamily: "var(--font-display)", fontSize: 22, fontWeight: 700, color: "var(--accent2)", letterSpacing: 0 },
  logoSub: { fontFamily: "var(--font-body)", fontSize: 11, color: "var(--muted)", marginTop: 2 },
  badge: { fontFamily: "var(--font-body)", fontSize: 11, background: "var(--accent-light)", color: "var(--accent)", padding: "3px 10px", fontWeight: 600, borderRadius: 20 },
  hero: { maxWidth: 960, margin: "0 auto", padding: "56px 24px 36px", borderBottom: "1px solid var(--border)" },
  heroTag: { fontFamily: "var(--font-body)", fontSize: 12, color: "var(--accent)", fontWeight: 600, letterSpacing: 1, marginBottom: 12, textTransform: "uppercase" },
  heroTitle: { fontFamily: "var(--font-display)", fontSize: "clamp(36px, 5vw, 56px)", fontWeight: 700, lineHeight: 1.15, color: "var(--text)", marginBottom: 16 },
  heroDesc: { color: "var(--muted)", fontSize: 16, lineHeight: 1.8, maxWidth: 520 },
  nav: { maxWidth: 960, margin: "0 auto", padding: "28px 24px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 12 },
  navBtn: { background: "#fff", border: "1.5px solid var(--border)", borderRadius: 10, padding: "18px 20px", textAlign: "left", cursor: "pointer", transition: "all 0.2s", display: "flex", flexDirection: "column", gap: 4, boxShadow: "0 1px 3px rgba(0,0,0,0.04)" },
  navBtnActive: { borderColor: "var(--accent)", background: "var(--accent-light)", boxShadow: "0 2px 8px rgba(26,115,232,0.12)" },
  navIcon: { fontSize: 22 },
  navLabel: { fontFamily: "var(--font-display)", fontSize: 15, fontWeight: 600, color: "var(--text)" },
  navDesc: { fontSize: 12, color: "var(--muted)" },
  main: { maxWidth: 960, margin: "0 auto", padding: "0 24px 60px", flex: 1, width: "100%" },
  card: { background: "#fff", border: "1.5px solid var(--border)", borderRadius: 12, padding: 32, boxShadow: "0 2px 8px rgba(0,0,0,0.04)" },
  cardTitle: { fontFamily: "var(--font-display)", fontSize: 22, fontWeight: 700, color: "var(--text)", marginBottom: 24 },
  label: { display: "block", fontFamily: "var(--font-body)", fontSize: 11, fontWeight: 600, color: "var(--accent)", letterSpacing: 1, marginBottom: 8, marginTop: 16, textTransform: "uppercase" },
  chips: { display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 8 },
  chip: { background: "#fff", border: "1.5px solid var(--border)", color: "var(--muted)", padding: "6px 14px", cursor: "pointer", fontSize: 13, fontFamily: "var(--font-body)", transition: "all 0.15s", borderRadius: 6 },
  chipActive: { borderColor: "var(--accent)", color: "var(--accent)", background: "var(--accent-light)", fontWeight: 600 },
  selectedInfo: { margin: "20px 0", fontSize: 14, color: "var(--muted)", background: "var(--surface)", padding: "12px 16px", borderRadius: 8 },
  btn: { marginTop: 24, background: "var(--accent)", color: "#fff", border: "none", padding: "14px 28px", fontSize: 15, fontWeight: 600, cursor: "pointer", fontFamily: "var(--font-body)", borderRadius: 8, width: "100%", transition: "background 0.2s" },
  chatMeta: { fontFamily: "var(--font-body)", fontSize: 12, fontWeight: 600, color: "var(--accent)", marginBottom: 16, textTransform: "uppercase", letterSpacing: 1 },
  chatBox: { minHeight: 300, maxHeight: 420, overflowY: "auto", display: "flex", flexDirection: "column", gap: 12, marginBottom: 16, padding: "4px 0" },
  bubble: { padding: "12px 16px", maxWidth: "85%", borderRadius: 10 },
  bubbleAI: { background: "var(--surface)", border: "1px solid var(--border)", alignSelf: "flex-start" },
  bubbleUser: { background: "var(--accent-light)", border: "1px solid rgba(26,115,232,0.2)", alignSelf: "flex-end" },
  bubbleRole: { fontFamily: "var(--font-body)", fontSize: 10, fontWeight: 700, color: "var(--muted)", letterSpacing: 1, textTransform: "uppercase" },
  inputRow: { display: "flex", gap: 8 },
  input: { flex: 1, background: "var(--surface)", border: "1.5px solid var(--border)", color: "var(--text)", padding: "12px 16px", fontSize: 14, fontFamily: "var(--font-body)", outline: "none", borderRadius: 8 },
  sendBtn: { background: "var(--accent)", border: "none", color: "#fff", padding: "12px 20px", fontSize: 16, cursor: "pointer", fontWeight: 700, borderRadius: 8 },
  resetBtn: { marginTop: 12, background: "transparent", border: "1px solid var(--border)", color: "var(--muted)", padding: "8px 16px", fontSize: 12, cursor: "pointer", fontFamily: "var(--font-body)", borderRadius: 6 },
  textarea: { width: "100%", background: "var(--surface)", border: "1.5px solid var(--border)", color: "var(--text)", padding: "14px 16px", fontSize: 14, fontFamily: "var(--font-body)", outline: "none", resize: "vertical", marginTop: 8, borderRadius: 8 },
  ...
  resultLabel: { fontFamily: "var(--font-body)", fontSize: 11, fontWeight: 700, color: "var(--accent)", letterSpacing: 2, marginBottom: 16, textTransform: "uppercase" },
  resultText: { whiteSpace: "pre-wrap", fontFamily: "var(--font-body)", fontSize: 14, lineHeight: 1.8, color: "var(--text)" },
  copyBtn: { marginTop: 16, background: "transparent", border: "1.5px solid var(--accent)", color: "var(--accent)", padding: "8px 20px", fontSize: 12, cursor: "pointer", fontFamily: "var(--font-body)", fontWeight: 600, borderRadius: 6 },
  footer: { borderTop: "1px solid var(--border)", padding: "24px", textAlign: "center", fontSize: 13, color: "var(--muted)", background: "var(--surface)" },
};
